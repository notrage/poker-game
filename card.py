...
class Card:
    ...
    def get_value(self) -> CardValue: return self.value
    
    def get_color(self) -> CardColor: return self.color
    
    def to_string(self) -> str: return self.value.to_string() + self.color.to_string()
